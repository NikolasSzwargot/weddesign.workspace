...
import { Container, CounterWrapper, GuestListWrapper, SearchBarWrapper, StatusBarWrapper } from './styles';
...
const GuestList = () => {
  ...
  const { countStatuses, countTotal, countChild, countOvernight, countVege, isLoading, isFetching, isError } =
    useGuestsStatistics();
  ...
  return (
    <Container>
      ...
      <GuestListWrapper>
        ...
        {isLoading || isLoadingGrouped ? (
          <LoadingSpinner color={Colors.LightBlue} msg={t('shared:spinnerMessage')} />
        ) : (
          <>
            <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
              <View>
                ...
                <CounterWrapper>
                  <Counter count={countChild} label={t('counters.child')} />
                  <Counter count={countOvernight} label={t('counters.accommodation')} />
                ...
                <SearchBarWrapper>
                  ...
                  <IconButton
                    ...
                    onPress={() => router.navigate(GuestListRoutes.ADD)}
                  />
                </SearchBarWrapper>
              </View>
            ...
            <SectionList
              ...
              renderItem={({ item }) => (
                <GuestItem
                  ...
                  onGuestPress={() => router.navigate(GuestListRoutes.ADD, item)}
            ...
            />
            <CustomOverlay isVisible={isUpdating || isDeleting || isFetchingGrouped || isFetching} variant={'center'}>
              <LoadingSpinner color={Colors.LightBlue}></LoadingSpinner>
            </CustomOverlay>
            ...
            <WeddesignConfirmationModal
              ...
              message={confirmationModalText}></WeddesignConfirmationModal>

            <StatusChangeModal
              isVisible={isStatusModalVisible}
              onBackdropPress={handleCancel}
              onStatusSelect={handleStatusChange}></StatusChangeModal>
          </>
        )}
      </GuestListWrapper>
    </Container>
