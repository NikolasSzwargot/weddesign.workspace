...
import { BackgroundEllipse, Header, RoundButton, TaskFrame } from '@weddesign/components';
import { Colors, ExpenseListRoutes, GuestListRoutes, HomeRoutes, ProvidersRoutes } from '@weddesign/enums';
import { Text } from '@weddesign/themes';
import { useTranslation } from 'react-i18next';
import { getDaysDifference } from '@weddesign/utils';
import { MockedUser } from '@weddesign-mobile/mocks';
      ...
      <HomeWrapper>
        ...
        <MainFrame>
          ...
          <Text.SemiBold size={16}>
            {t('counter', {
              days: getDaysDifference(new Date(), new Date(MockedUser.weddingDate)),
            })}
          </Text.SemiBold>
          <TaskFrame />
        </MainFrame>
